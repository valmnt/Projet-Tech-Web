                ...
                <article class="contenu_onglet1" style="display:block">
                    ...
                    <article class="contenu_onglet2" style="display:none">
                        <div class="conteneur_text">
                            ...
                            <p class="text_projet">tiers, par le biais d’un CV ainsi que des exemples de réalisations. Nous devons donc </p>
                            <p class="text_projet">concevoir un site web qui doit être notre curriculum. Notre site web doit comporter </p>
                        ...
                        <article class="contenu_onglet3" style="display:none">
                                <div class="conteneur_text">
                                    ...
                                    <p class="text_projet">allons fournir à nos clients une base de données, que l’utilisateur peut étendre, qui contient initialement les spécifications de</p>
